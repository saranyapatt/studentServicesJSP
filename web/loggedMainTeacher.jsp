...
<html lang="en">
    ...
    <body>
        <%
            try {
                ...
                if (r.next()) {
                    ...
                    session.setAttribute("teacher_id", r.getString("teacher_id"));
                    session.setAttribute("class", r.getString("class"));
                } else {
                    response.sendRedirect("index.jsp");
                    return;
                }
        ...
        <div class="sidebar shadow">
            ...
            <h5 class="mb-4 text-white text-center">Welcome, <%= r.getString("name")%></h5> <nav>
                <a href="loggedMainTeacher.jsp" class="nav-link-custom active">🏠 Home</a>
